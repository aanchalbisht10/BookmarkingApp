...
//			 int typeoffset=(int)(Math.random()* DataStore.BOOKMARK_TYPES_COUNT); --> type of bookmark among the three
//			 int bookmarkOffset=(int)(Math.random()* DataStore.BOOKMARK_COUNT_PER_TYPE); -->selects bookmark itself
//		     
//			 Bookmark bookmark=bookmarks[typeoffset][bookmarkOffset];  -->data saved
//			 
//			 BookmarkController.getInstance().saveUserBookmark(user,bookmark);
